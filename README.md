...
# LearningApi
Learning API is Machine Learning Foundation of a set of ML libraries fully implemented in .NET Core. It provides a unique processing API for Machine Learning solutions. It has been developed in cooperation with daenet GmBh and Frankfurt University of Applied Sciences.
