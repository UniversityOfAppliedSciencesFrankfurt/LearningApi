...
namespace LearningFoundation.MlAlgorithms.RingProjectionAlgorithm
{
    public static class BinarizerExtension
    {
        ...
        /// <returns></returns>
        public static double[][] GetBinaryArray(this ImageBinarizer bi, string image, int threshold)
        {
            Bitmap m_img;
        ...
        public static double[][] GetBinaryArray(
            this ImageBinarizer bi, string image, 
            out Bitmap img, int threshold)
        {
            img = (Bitmap)System.Drawing.Image.FromFile(image);
        ...
        /// <returns></returns>
        public static double[][] ConvertToBinary(this ImageBinarizer bi, double[][] mnistImage, int threshold)
        {
