...
namespace ConvolutionalNetworks
{
    ...
    {
        /// <summary>
        /// Stacked Network Implementation
        /// </summary>
        ...
        /// <param name="isTraining">Boolean isTraining Flag</param>
		...
		/// </summary>
		/// <returns>Gradients and Tangent Points</returns>
		...
		/// <returns>Forward Pass result tensor</returns>
