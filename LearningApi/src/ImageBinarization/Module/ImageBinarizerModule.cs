...
namespace LearningFoundation.Binarization.ImageBinarizer
{
    public class ImageBinarizerModule : IPipelineModule<double[,,], double[,,]>
    {
        ...
        public ImageBinarizerModule(Dictionary<String, int> imageParams)
        {
            int targetWidth = 0;
            int targetHeight = 0;
        ...
        public double[,,] GetBinary(double[,,] data)
        {
            ...
            for (int i = 0; i < data.GetLength(0); i++)
            {
                for (int j = 0; j < data.GetLength(1); j++)
                {
                    ...
                    img.SetPixel(i, j, Color.FromArgb(255, (int)data[i, j, 0], (int)data[i, j, 1], (int)data[i, j, 2]));
                }
            }
