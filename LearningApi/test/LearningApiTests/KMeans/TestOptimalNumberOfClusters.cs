...
using LearningFoundation.Test.FunctionGenerators;

namespace LearningFoundation.Test.OptimalNumberOfClusters
{
    [TestClass]
    public class TestOptimalNumberOfClusters
    {
        ...
        [TestMethod]
        public void OptimalNumberOfCLustersBasicTest()
        {
        ...
        [TestMethod]
        public void OptimalNumberOfCLustersTest()
        {
            // directory to load
            ...
            double[][] function = FunctionRecognition.Helpers.LoadFunctionData(loadDirectory + FunctionName + "\\" + FunctionName + ".csv");
            ...
            FunctionRecognition.Helpers.Write2CSVFile(OptimalClustersResults, savePath);
        ...
        public void Test_OptimalNumberOfClusters_TwoFunctions()
        {
            ...
            // load Data
            double[][] loadedSimFunctions1 = LearningFoundation.Test.FunctionRecognition.Helpers.LoadFunctionData(loadDirectory + functionA + "\\NRP5-10\\" + functionA + " SimilarFunctions Normalized NRP5-10.csv");
            double[][] loadedSimFunctions2 = LearningFoundation.Test.FunctionRecognition.Helpers.LoadFunctionData(loadDirectory + functionB + "\\NRP5-10\\" + functionB + " SimilarFunctions Normalized NRP5-10.csv");
