...
using LearningFoundation.Test.FunctionRecognition;

namespace LearningFoundation.Test.KMeansMainFunctions
{
    /// <summary>
    ...
    public class TestKMeansMainFunctions
    {
        ...
        //    double[][] rawData = LearningFoundation.Test.FunctionRecognition.Helpers.CreateSampleData(clusterCenters, 2, 10000, 0.5);
        //    double[][] rawData2 = LearningFoundation.Test.FunctionRecognition.Helpers.CreateSampleData(clusterCenters2, 2, 5000, 0.5);
        ...
        //    Assert.IsNotNull(api2Resp.Model.Clusters);
        //    Assert.AreEqual(api2Resp.Model.Clusters.Length, clusterCenters.Length);
        ...
        //    Assert.IsNotNull(apiResp.Model.Clusters);
        //    Assert.AreEqual(apiResp.Model.Clusters.Length, clusterCenters.Length);
        ...
        //            Assert.AreEqual(apiResp.Model.Clusters[i].Centroid[j], f * res);
        //        }
        ...
        public void LoadTest()
        {
            ...
            Assert.IsNotNull(kMeans.Instance);
            Assert.IsNotNull(kMeans.Instance.Clusters);
        }
