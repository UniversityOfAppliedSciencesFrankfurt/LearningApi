...
namespace LearningFoundation.Test.FunctionGenerators
{   
    /// <summary>
   ...
   [TestClass]
    public class TestFunctionGenerators
    {
        ...
        /// </summary>
        [TestMethod]
        public void GenerateSimilarFunctionsTest()
        {
        ...
        private static void generateSimilarFunctions(string functionName, int numFunctions, int MinNoiseRangePercentage, int MaxNoiseRangePercentage)
        {
            ...
            LearningFoundation.Test.FunctionRecognition.Helpers.CheckOrCreateDefaultFunction(path, functionFileName, 100, 2);

            // load original function
            double[][] referenceFunction = LearningFoundation.Test.FunctionRecognition.Helpers.LoadFunctionData(Path.Combine(path, functionFileName));
            ...
            LearningFoundation.Test.FunctionRecognition.Helpers.Write2CSVFile(referenceFunction, fName);
            LearningFoundation.Test.FunctionRecognition.Helpers.Write2CSVFile(NormalizeData(referenceFunction), fNameNormalized);
            ...
            for (int i = 0; i < numFunctions; i++)
            {
                ...
                LearningFoundation.Test.FunctionRecognition.Helpers.Write2CSVFile(similarFuncData, fName, true);
                LearningFoundation.Test.FunctionRecognition.Helpers.Write2CSVFile(NormalizeData(similarFuncData), fNameNormalized, true);
            }
        }
