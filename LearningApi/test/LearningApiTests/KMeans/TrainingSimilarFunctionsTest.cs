...
namespace LearningFoundation.Test.Globals
{
    ...
    /// </summary>
    [TestClass]
    public class TrainingSimilarFunctionsTest
    {
        ...
        public void Test_TrainingSimilarFunctions()
        {
            ...
            double[][] allFunctionsData = FunctionRecognition.Helpers.LoadFunctionData(directory + "\\NRP" + NRP + "\\" + FunctionName + " SimilarFunctions NRP" + NRP + ".csv");
            ...
            for (int k = 2; k < numClusters + 1; k++)
            {
                ...
                for (int j = 0; j < Runs; j++)
                {
                    ...
                    for (int funcIndx = 0; funcIndx < numFunc; funcIndx++)
                    {
                        ...
                        {
                            // save or overwrite
                            FunctionRecognition.Helpers.Write2CSVFile(Centroids, savePath);
                        }
                        else
                        {
                            // append
                            FunctionRecognition.Helpers.Write2CSVFile(Centroids, savePath, true);
                        }
                    }
                }
            }
