...
using LearningFoundation.Test.Globals;

namespace LearningFoundation.Test.FunctionRecognition
{
    [TestClass]
    public class TestFunctionRecognition
    {
        ...
        /// </summary>
        [TestMethod]
        public void FunctionRecognitionAppTest()
        {
            int numCluster = 2;
        ...
        [TestMethod]
        public void FunctionRecognitionTest()
        {
            int numAttributes = 3;
            int numClusters = 2;
            int maxCount = 300;
        ...
        /// </summary>      
        [TestMethod]
        public void FunctionRecognitionModuleCustomFuncTest()
        {
            #region Training
            int points = 22;
            var batch = 100;
        ...
        private static Tuple<double[][], double[]> formClusters(string path, int numClusters, int numTrainFun)
        {
            ...
            for (int i = 0; i < numTrainFun; i++)
            {
                for (int j = 0; j < numClusters; j++)
                {
                    calDist = Math.Sqrt(TrainingSimilarFunctionsTest.squaredDistance(clusterCentroids[j], trainedCentroids[i * numClusters + j]));
