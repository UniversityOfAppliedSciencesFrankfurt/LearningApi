...
namespace test.logisticregression
{
    ...
    /// 
    /// </summary>
    public class LogisticRegressionMedicalTests2
    {

        public LogisticRegressionMedicalTests2()
        {
        ...
        public void LogisticsRegression_Test_iterations_10_learningrate_013()
        {
            ...
            api.Save("LogisticRegression.json");
            ...
            var api2 = LearningApi.Load("LogisticRegression.json");

            var result2 = api.Algorithm.Predict(testData as double[][], api.Context) as LogisticRegressionResult;
